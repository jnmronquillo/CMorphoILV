...
--*/
{
    ...
    bResult = WinUsb_GetAssociatedInterface(DeviceData->WinusbHandle[0], 0, &DeviceData->WinusbHandle[1]);
...
--*/
{
    ...
    WinUsb_Free(DeviceData->WinusbHandle[0]);
    WinUsb_Free(DeviceData->WinusbHandle[1]);
    CloseHandle(DeviceData->DeviceHandle);
    DeviceData->HandlesOpen = FALSE;
